# Règles de sécurité — catalogue exercices

1. **Niveau E** : confort / stimulation seulement. Aucun transfert, aucune propulsion autonome, aucune marche.
2. **Niveau D** : transferts uniquement selon technique déjà enseignée à l'aidant ; sinon rester sur participation partielle / confort.
3. **Monter de niveau** (`crossesAutonomyLevel = true`) : l'exercice suivant n'est **jamais** auto-proposé à l'aidant ; alerte pro obligatoire.
