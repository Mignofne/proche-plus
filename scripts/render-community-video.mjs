 ...
 *   npm run community:render-video -- --composition=ProchePlusShort
 *
...
console.log("[community:render-video] Rendu Remotion CLI…");
console.log(
...
try {
  execSync(
    `npx remotion render src/remotion/index.ts ProchePlusShort "${outFile}"`,
